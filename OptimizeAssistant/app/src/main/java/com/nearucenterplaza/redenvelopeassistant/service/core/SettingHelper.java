...
public class SettingHelper {
	...
	private static final String RE_CHAT_ONLY_MODE = "re_mode_chat_only";
	...
	public static boolean setREChatOnlyMode(boolean value) {
		return PreferenceUtil.setBooleanValue(RE_CHAT_ONLY_MODE, value);
	}

	public static boolean getREChatOnlyMode() {
		return PreferenceUtil.getBooleanValue(RE_CHAT_ONLY_MODE, false);
	}
}
